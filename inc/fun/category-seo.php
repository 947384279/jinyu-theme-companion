...
function jinyu_category_seo_edit_fields($term): void
{
    ...
    <tr class="form-field">
        ...
        <td>
            <input name="jinyu_seo_cat_keywords" id="jinyu_seo_cat_keywords" type="text" value="<?php echo esc_attr($kw_html); ?>" size="40"><br>
    ...
    <tr class="form-field">
        ...
        <td>
            <input name="jinyu_seo_cat_desc" id="jinyu_seo_cat_desc" type="text" value="<?php echo esc_attr($desc_html); ?>" size="40"><br>
...
function jinyu_category_seo_save(int $term_id): void
{
    ...
    if (isset($_POST['jinyu_seo_cat_keywords'])) {
        update_term_meta($term_id, 'jinyu_seo_cat_keywords', sanitize_text_field(wp_unslash($_POST['jinyu_seo_cat_keywords'])));
    }
    if (isset($_POST['jinyu_seo_cat_desc'])) {
        update_term_meta($term_id, 'jinyu_seo_cat_desc', sanitize_text_field(wp_unslash($_POST['jinyu_seo_cat_desc'])));
    }
}
